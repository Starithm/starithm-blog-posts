...
# GBM_794811435 Update

Multi-wavelength follow-up observations have significantly expanded our understanding of this long gamma-ray burst. Spectral analysis confirms classification as a long burst with **T90 = 86s**, **Ep = 175 keV**, and **Eiso = 9.8×10⁵⁰ erg**. The burst's redshift of **z = 0.153** places it relatively nearby, enabling detailed afterglow studies across the electromagnetic spectrum. Radio detections from the VLA and NOEMA reveal persistent emission at multiple frequencies, with NOEMA measuring **17 mJy at 100 GHz** and a luminosity of **10⁴² erg/s**.

Optical and near-infrared observations present an intriguing puzzle. While multiple teams (SVOM, LBT, COLIBRÍ) detected the optical counterpart AT2026fgk, conflicting reports emerged regarding late-time rebrightening. The COLIBRÍ team reported rebrightening across multiple filters six days post-burst, yet independent observations from AZT-33IK and Wendelstein Observatory found no evidence of this feature. *This discrepancy warrants urgent clarification through coordinated follow-up observations*, particularly to search for an associated supernova. NuSTAR's hard X-ray detection provides additional constraints on the high-energy afterglow properties.
...
The Chandra X-ray Observatory has detected continued X-ray emission from the multi-wavelength transient AT2026fgk at **127 days post-burst**, with a detection significance of **6.2-sigma**. This observation extends our understanding of the source's long-term evolution and confirms *sustained X-ray activity well into the late-time phase of the transient*.

The detected flux remains consistent with the decay slope measured in earlier Chandra observations, indicating *a stable power-law decline without significant deviations*. This regularity in the X-ray behavior suggests *a standard afterglow origin*, likely powered by the external shock as the relativistic jet continues to decelerate into the surrounding medium. The persistence of detectable X-rays at this late epoch provides valuable constraints on the circumburst density and the energy budget of GRB 260310A's relativistic outflow.
...
@misc{starithm2026gbm794811435,
  title     = {GRB 260310A: Long GRB with associated Type Ic-BL supernova at z=0.153},
